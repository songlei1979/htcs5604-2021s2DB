...
$cfg['Servers'][$i]['user'] = 'ljin5ogk653pw6mq'; //change to yours
$cfg['Servers'][$i]['password'] = 'zlteqsqk66bzqcr5'; //change to yours
/* Server parameters */
$cfg['Servers'][$i]['host'] = 'ro2padgkirvcf55m.cbetxkdyhwsb.us-east-1.rds.amazonaws.com'; //change to yours
